        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("Pk_SubSubclassification", x => x.Id)
                        .Annotation("SqlServer:Clustered", true);
                    table.ForeignKey(
                        name: "FK_SubClassificationBases_SubSubclassifications",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    Code = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    Price = table.Column<decimal>(type: "decimal(0,20)", precision: 0, scale: 20, nullable: true),
                    Cost = table.Column<decimal>(type: "decimal(0,20)", precision: 0, scale: 20, nullable: true),
                    Quantity = table.Column<int>(type: "int", nullable: true),
                    Logo = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    EnDetails = table.Column<string>(type: "MAX", nullable: false),
                    ArDetails = table.Column<string>(type: "MAX", nullable: false),
                    MinOrderQuantity = table.Column<decimal>(type: "decimal(0,20)", precision: 0, scale: 20, nullable: true),
                    MaxOrderQuantity = table.Column<decimal>(type: "decimal(0,20)", precision: 0, scale: 20, nullable: true),
                    Discount = table.Column<decimal>(type: "decimal(0,20)", precision: 0, scale: 20, nullable: true),
