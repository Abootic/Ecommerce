           ...
           migrationBuilder.EnsureSchema(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SizeName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("Pk_ProductVariation", x => x.Id)
                        .Annotation("SqlServer:Clustered", true);
                    table.ForeignKey(
                        name: "FK_ProductAttributeId_ProductVariation",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "4a2e1650-21bd-4e67-832e-2e99c267a2e4", 0, "49298d3d-7eba-4800-826b-586c4b0c0fd0", new DateTime(2023, 9, 27, 20, 20, 5, 379, DateTimeKind.Local).AddTicks(5922), null, null, null, "Admin@Gmail.com", false, "Admin", "unkown", false, null, null, false, null, "ADMIN@GMAIL.COM", "ADMIN", null, "AQAAAAEAACcQAAAAEOwINDvszCK7jb2E9hscAKY978vKSDAjgw9s/cm69UV0ub/7vvPLSdecyXBbH0WO0Q==", "123456789", false, "1457130f-0d28-461b-9c23-5a5d1d7aeab4", null, false, "Admin", null });
