    ...
    public class CouponConfigration : IEntityTypeConfiguration<Coupon>
    {
        public void Configure(EntityTypeBuilder<Coupon> builder)
        {
            ...
            builder.Property(x => x.EndDate).HasColumnName(@"EndDate").HasColumnType("datetime2").IsRequired();
             ...
             builder.Property(x=>x.ApplyTo).HasColumnName(@"ApplyTo").HasColumnType("nvarchar(255)").IsRequired(false).HasMaxLength(255);
             builder.Property(x=>x.QtRequire).HasColumnName(@"QtRequire").HasColumnType("decimal").IsRequired(false);
             ...
             builder.Property(x=>x.Details).HasColumnName(@"Details").HasColumnType("nvarchar(255)").IsRequired(false).HasMaxLength(255);
