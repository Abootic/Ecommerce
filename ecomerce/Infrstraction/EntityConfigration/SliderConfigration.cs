...
namespace EcommereceWeb.Infrstraction.EntityConfigration
{
    public class SliderConfigration : IEntityTypeConfiguration<Slider>
    {
        public void Configure(EntityTypeBuilder<Slider> builder)
        {
            ...
            builder.Property(x => x.EnDetails).HasColumnName(@"EnDetails").HasColumnType("MAX").IsRequired(false).HasMaxLength(255);
            builder.Property(x => x.ArDetails).HasColumnName(@"ArDetails").HasColumnType("MAX").IsRequired(false).HasMaxLength(255);
