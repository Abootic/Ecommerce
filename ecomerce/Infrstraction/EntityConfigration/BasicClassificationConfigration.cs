...
namespace EcommereceWeb.Infrstraction.EntityConfigration
{
    public class BasicClassificationConfigration : IEntityTypeConfiguration<BasicClassification>
    {
        public void Configure(EntityTypeBuilder<BasicClassification> builder)
        {
            ...
            builder.Property(x => x.BasicClassificationEnName).HasColumnName(@"BasicClassificationEnName").HasColumnType("nvarchar(255)").IsRequired(false).HasMaxLength(255);
            builder.Property(x => x.BasicClassificationArName).HasColumnName(@"BasicClassificationArName").HasColumnType("nvarchar(255)").IsRequired().HasMaxLength(255);
